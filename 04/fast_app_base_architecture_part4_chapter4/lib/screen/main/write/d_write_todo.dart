...
import 'package:fast_app_base_architecture/common/util/app_keyboard_util.dart';
import 'package:fast_app_base_architecture/common/widget/w_round_button.dart';
import 'package:fast_app_base_architecture/data/simple_result.dart';
...
class _WriteTodoBottomSheetState extends DialogState<WriteTodoBottomSheet>
  ...
  void done(BuildContext context) {
    ...
    widget.hide(SimpleResult.success(TodoWriteResult(
        title: todoTextEditingController.text, dueDate: _selectedDate)));
  }
}
