import 'package:todo_statemanagement/class/ch04_advanced_dart1/object_oriented_programming/1_characteristic/animal.dart';

main() {
  /// 객체지향 프로그래밍(OOP)의 특징

  /// 1. 추상화 (Abstraction)
  ///   - Abstraction class (extends - only 1)
  ///     - Animal - age, eat() extends
  ///     - Dog, Cat
  ///
