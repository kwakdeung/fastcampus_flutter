...
final bankAccountShinhan1 =
    BankAccount(bankShinhan, 300, accountTypeName: "신한 주거래 우대통장(저축예금)");
final bankAccountShinhan2 =
    BankAccount(bankShinhan, 200, accountTypeName: "저축예금");
final bankAccountShinhan3 =
    BankAccount(bankShinhan, 100, accountTypeName: "저축예금");
final bankAccountToss = BankAccount(bankTtoss, 400);
final bankAccountKakao =
    BankAccount(bankKakao, 70000, accountTypeName: "입출금통장");
final bankAccountKakao2 =
    BankAccount(bankKakao, 1000000, accountTypeName: "특별통장");
